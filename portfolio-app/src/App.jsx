          ...
          >
            <form onSubmit={handleSubmit} className="grid gap-6">
              ...
              <motion.button 
                ...
                whileTap={{ scale: 0.98 }}
                type="submit"
                className="w-full py-4 bg-gradient-to-r from-blue-500 to-indigo-600 text-white font-semibold rounded-xl hover:from-blue-600 hover:to-indigo-700 transition-all"
              >
                Send Message
              </motion.button>
            </form>
